...
def init_level():
    ...
    blocks = [
        ...
        Block(400, 260, 50, 200),
        Block(600, 260, 50, 50),
        Block(800, 260, 50, 200),
        Block(1000, 260, 50, 50),
    ...
    triangles = [
        ...
        Triangle(blocks[5], offset_x=25, offset_y=-25, size=45),
        Triangle(blocks[0], offset_x=575, offset_y=-25, size=45),
        Triangle(blocks[0], offset_x=875, offset_y=-25, size=45),
        Triangle(blocks[0], offset_x=2120, offset_y=-40, size=15),
        Triangle(blocks[0], offset_x=975, offset_y=-25, size=45),
        Triangle(blocks[0], offset_x=1275, offset_y=-25, size=45),
        Triangle(blocks[0], offset_x=1375, offset_y=-25, size=45),
        Triangle(blocks[0], offset_x=1675, offset_y=-25, size=45),
        Triangle(blocks[0], offset_x=1885, offset_y=-25, size=45)
    ]
