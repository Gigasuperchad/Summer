...
sound = pygame.mixer.Sound("aphex-twin-xtal.mp3")
...
sun_surf = pygame.image.load('401-4016830_pixel-moon-digital-artwork-art.png').convert()
sun_surf = pygame.transform.scale(sun_surf, (400, 400))

def backgoround():
    for i in range(30):
        pygame.draw.polygon(screen, (0, 0,0), [(a[i]-z//b[i],600-c[i]-w//b[i]),(a_1[i]-z//b[i],800),(a_2[i]-z//b[i],800)], 1)
        pygame.draw.polygon(screen, (0, 0,0), [(500-a[i]-z//b[i],600-c[i]-w//b[i]),(500-a_1[i]-z//b[i],800),(500-a_2[i]-z//b[i],800)], 1)
        pygame.draw.polygon(screen, (0, 0,0), [(1000+a[i]-z//b[i],600-c[i]-w//b[i]),(1000+a_1[i]-z//b[i],800),(1000+a_2[i]-z//b[i],800)], 1)
...
def ground3d():
    for i in range(0,30,3):
        pygame.draw.rect(screen, (255-i*5,255-i*5,255-i*5), (block.rect[0]-i,(block.rect[1]+i)-15,block.rect[2],block.rect[3]))
...
while running:
    ...
    screen.blit(sun_surf, ((-z//50+700)-420, 100))
